				...
				<div id="header">
					...
					<div class="menu">
						<ul>
							...
							<li><a href="Customers.jsp" target="_self">Our Customers</a></li>
							<li></li>
							<li><a href="AboutUs.jsp" target="_self">Contact Us</a></li>
						</ul>
					</div>
				</div>
...
<!--  Displaying list of Customers -->
	<div class="container">
	<h1>Contact Us:</h1>
    <h2>Our mailing address:</h2>><br><h3> roop@husky.neu.edu<br>
